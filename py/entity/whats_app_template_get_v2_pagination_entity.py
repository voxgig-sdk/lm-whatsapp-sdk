...
class WhatsAppTemplateGetV2PaginationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WhatsAppTemplateGetV2PaginationEntity(self._client, opts)
    ...
    def data_get(self) -> WhatsAppTemplateGetV2Pagination:
    ...
    def match_get(self) -> WhatsAppTemplateGetV2Pagination:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WhatsAppTemplateGetV2Pagination:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WhatsAppTemplateGetV2Pagination().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
