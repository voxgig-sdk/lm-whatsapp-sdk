...
from lmwhatsapp_types import (
    ...
    WhatsAppTemplateGetV2LoadMatch,
)
...
class WhatsAppTemplateGetV2Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WhatsAppTemplateGetV2Entity(self._client, opts)
    ...
    def data_get(self) -> WhatsAppTemplateGetV2:
    ...
    def match_get(self) -> WhatsAppTemplateGetV2:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WhatsAppTemplateGetV2:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WhatsAppTemplateGetV2().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
