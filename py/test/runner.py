...
class LmWhatsappTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmWhatsappTestRunner.getenv("LMWHATSAPP_TEST_LIVE")
        override = LmWhatsappTestRunner.getenv("LMWHATSAPP_TEST_OVERRIDE")
        ...
        explain = LmWhatsappTestRunner.getenv("LMWHATSAPP_TEST_EXPLAIN")
