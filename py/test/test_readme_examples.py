# LmWhatsapp SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LmWhatsappSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LmWhatsappSDK(...) and LmWhatsappSDK.test(...) become
#      LmWhatsappSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "lmwhatsapp_sdk"
_SDK_CLASS = "LmWhatsappSDK"
