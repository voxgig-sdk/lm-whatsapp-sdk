...
from lmwhatsapp_sdk.utility import register

# Load features
from lmwhatsapp_sdk.feature.base_feature import LmWhatsappBaseFeature
from lmwhatsapp_sdk.features import _has_feature, _make_feature
...
class LmWhatsappSDK:
    ...
    def get_utility(self):
        return LmWhatsappUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LmWhatsappSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def ManageTemplate(self, data=None) -> "ManageTemplateEntity":
        """Entity factory: client.ManageTemplate().list() / client.ManageTemplate().load({"id": ...})."""
        from lmwhatsapp_sdk.entity.manage_template_entity import ManageTemplateEntity
        return ManageTemplateEntity(self, data)


    def Media(self, data=None) -> "MediaEntity":
        """Entity factory: client.Media().list() / client.Media().load({"id": ...})."""
        from lmwhatsapp_sdk.entity.media_entity import MediaEntity
    ...
    def SendMessage(self, data=None) -> "SendMessageEntity":
        ...
        from lmwhatsapp_sdk.entity.send_message_entity import SendMessageEntity
    ...
    def Template(self, data=None) -> "TemplateEntity":
        ...
        from lmwhatsapp_sdk.entity.template_entity import TemplateEntity
        return TemplateEntity(self, data)


    def WhatsAppTemplateGetV2(self, data=None) -> "WhatsAppTemplateGetV2Entity":
        """Entity factory: client.WhatsAppTemplateGetV2().list() / client.WhatsAppTemplateGetV2().load({"id": ...})."""
        from lmwhatsapp_sdk.entity.whats_app_template_get_v2_entity import WhatsAppTemplateGetV2Entity
        return WhatsAppTemplateGetV2Entity(self, data)


    def WhatsAppTemplateGetV2Pagination(self, data=None) -> "WhatsAppTemplateGetV2PaginationEntity":
        """Entity factory: client.WhatsAppTemplateGetV2Pagination().list() / client.WhatsAppTemplateGetV2Pagination().load({"id": ...})."""
        from lmwhatsapp_sdk.entity.whats_app_template_get_v2_pagination_entity import WhatsAppTemplateGetV2PaginationEntity
        return WhatsAppTemplateGetV2PaginationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "LmWhatsappSDK":
        if sdkopts is None:
            sdkopts = {}
