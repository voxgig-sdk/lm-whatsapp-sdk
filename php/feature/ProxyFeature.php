...
class LmWhatsappProxyFeature extends LmWhatsappBaseFeature
{
    ...
    public function init(LmWhatsappContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LmWhatsappContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
