...
// LmWhatsapp SDK streaming feature
...
class LmWhatsappStreamingFeature extends LmWhatsappBaseFeature
{
    ...
    private function _iterate(LmWhatsappResult $result): \Generator
    {
    ...
    private function _streamable(LmWhatsappContext $ctx): bool
    {
