...
// LmWhatsapp SDK ratelimit feature
...
class LmWhatsappRatelimitFeature extends LmWhatsappBaseFeature
{
    ...
    private function _acquire(LmWhatsappContext $ctx): void
    {
    ...
    private function _track(LmWhatsappContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
