...
// LmWhatsapp SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class LmWhatsappMakeRequest
{
    public static function call(LmWhatsappContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LmWhatsappResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LmWhatsappResponse($fetched);
        } else {
