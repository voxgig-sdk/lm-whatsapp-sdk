...
class ManageTemplateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ManageTemplateEntity($this->_client, $opts);
    }

    /**
     * @param ManageTemplate|array $args ManageTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return ManageTemplate|array The current ManageTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ManageTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ManageTemplate fields).
     */
    ...
    /**
     * Remove an ManageTemplate matching the given criteria.
     *
     * @param ManageTemplateRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ManageTemplateRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ManageTemplate|array The removed ManageTemplate as an assoc-array at the
