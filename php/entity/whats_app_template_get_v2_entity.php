...
// LmWhatsapp SDK WhatsAppTemplateGetV2 entity
...
class WhatsAppTemplateGetV2Entity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "whats_app_template_get_v2";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WhatsAppTemplateGetV2Entity($this->_client, $opts);
    }

    /**
     * @param WhatsAppTemplateGetV2|array $args WhatsAppTemplateGetV2 data (assoc-array) to store.
     */
    ...
    /**
     * @return WhatsAppTemplateGetV2|array The current WhatsAppTemplateGetV2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhatsAppTemplateGetV2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WhatsAppTemplateGetV2 fields).
     */
    ...
    /**
     * Load a single WhatsAppTemplateGetV2.
     *
     * @param WhatsAppTemplateGetV2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WhatsAppTemplateGetV2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhatsAppTemplateGetV2|array The loaded WhatsAppTemplateGetV2 as an assoc-array at the
