...
class WhatsAppTemplateGetV2PaginationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "whats_app_template_get_v2_pagination";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WhatsAppTemplateGetV2PaginationEntity($this->_client, $opts);
    }

    /**
     * @param WhatsAppTemplateGetV2Pagination|array $args WhatsAppTemplateGetV2Pagination data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = LmWhatsappHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return WhatsAppTemplateGetV2Pagination|array The current WhatsAppTemplateGetV2Pagination data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhatsAppTemplateGetV2Pagination fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = LmWhatsappHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of WhatsAppTemplateGetV2Pagination fields).
     */
    ...
    /**
     * Load a single WhatsAppTemplateGetV2Pagination.
     *
     * @param WhatsAppTemplateGetV2PaginationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WhatsAppTemplateGetV2PaginationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhatsAppTemplateGetV2Pagination|array The loaded WhatsAppTemplateGetV2Pagination as an assoc-array at the
     *   SDK boundary; throws LmWhatsappError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = LmWhatsappHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
