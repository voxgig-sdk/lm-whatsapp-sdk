...
// LmWhatsapp SDK Template entity
...
class TemplateEntity
{
     ...
     *
     * @param TemplateUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TemplateUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Template|array The updated Template as an assoc-array at the
     *   SDK boundary; throws LmWhatsappError on failure (item-5 convention).
     */
