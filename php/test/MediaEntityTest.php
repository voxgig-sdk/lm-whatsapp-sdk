...
class MediaEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LM_WHATSAPP_TEST_MEDIA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function media_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LM_WHATSAPP_TEST_MEDIA_ENTID");
