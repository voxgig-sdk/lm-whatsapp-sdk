...
// LmWhatsapp SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LmWhatsappSDK::test)
...
{
    private const SDK_CLASS = 'LmWhatsappSDK';
    ...
    private const SDK_BASE = 'lmwhatsapp_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../lmwhatsapp_sdk.php';
