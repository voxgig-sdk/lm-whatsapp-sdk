...
class WhatsAppTemplateGetV2PaginationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LM_WHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V2_PAGINATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function whats_app_template_get_v2_pagination_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LM_WHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V2_PAGINATION_ENTID");
