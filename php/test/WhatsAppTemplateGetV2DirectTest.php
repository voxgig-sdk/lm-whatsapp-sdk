...
class WhatsAppTemplateGetV2DirectTest extends TestCase
{
    public function test_direct_load_whats_app_template_get_v2(): void
    {
        $setup = whats_app_template_get_v2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-whats_app_template_get_v2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
