...
// LmWhatsapp SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LmWhatsappOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LmWhatsappOmni::structfix($now, Struct::undef()))
                        !== json_encode(LmWhatsappOmni::structfix($val, Struct::undef()))) {
