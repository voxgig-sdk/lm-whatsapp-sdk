...
```php
<?php
require_once 'lmwhatsapp_sdk.php';
...
print_r($whatsapptemplategetv2->data_get());
```
...
```
php/
├── lmwhatsapp_sdk.php          -- Main SDK class
...
The main class (`lmwhatsapp_sdk.php`) exports the SDK class
