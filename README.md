...
Learn more about MyLINK WhatsApp API at [linkmobility.com](https://linkmobility.com).

This is an unofficial SDK for the MyLINK WhatsApp public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
// whatsapptemplategetv2 is a bare WhatsAppTemplateGetV2 populated with mock data
...
```json
{
  "mcpServers": {
    "lm-whatsapp": {
      "command": "/abs/path/to/lm-whatsapp-mcp"
    }
  }
}
```
...
```go
import sdk "github.com/voxgig-sdk/lm-whatsapp-sdk/go"
...
Generated from the MyLINK WhatsApp API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
