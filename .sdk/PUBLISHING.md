...
|---|---|---|
| `ts/` | @voxgig-sdk/lm-whatsapp | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/lm-whatsapp \
      --repository voxgig-sdk/lm-whatsapp-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/lm-whatsapp` shows it, and
`npm trust revoke @voxgig-sdk/lm-whatsapp --id=<id>` removes it.
