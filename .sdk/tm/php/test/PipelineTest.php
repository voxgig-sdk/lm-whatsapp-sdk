...
{
    private static function utility(): LmWhatsappUtility
    {
        return new LmWhatsappUtility();
    }
    ...
    private static function ctx(array $over = []): LmWhatsappContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LmWhatsappContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LmWhatsappOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LmWhatsappError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LmWhatsappOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LmWhatsappMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LmWhatsappOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LmWhatsappMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LmWhatsappOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LmWhatsappMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmWhatsappSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LmWhatsappMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LmWhatsappResponse([]),
            'result' => new LmWhatsappResult([]),
        ]);
        [, $err] = LmWhatsappMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LmWhatsappSpec([]),
            'response' => null,
            'result' => new LmWhatsappResult([]),
        ]);
        [, $err] = LmWhatsappMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LmWhatsappSpec(['step' => 's']),
            'response' => new LmWhatsappResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LmWhatsappResult([]),
        ]);
        [, $err] = LmWhatsappMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LmWhatsappSpec(['step' => 's']),
            'response' => new LmWhatsappResponse(self::resp(200, ['v' => 1])),
            'result' => new LmWhatsappResult([]),
        ]);
        [, $err] = LmWhatsappMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LmWhatsappSpec(['step' => 's']),
            'response' => new LmWhatsappResponse(self::resp(200, ['v' => 2])),
            'result' => new LmWhatsappResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LmWhatsappMakeResponse::call($ctx);
    ...
    {
        $preset = new LmWhatsappResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LmWhatsappSpec([]),
            'response' => new LmWhatsappResponse([]),
            'result' => new LmWhatsappResult([]),
        ...
        [$got, $err] = LmWhatsappMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LmWhatsappResult([])]);
        [, $err] = LmWhatsappMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LmWhatsappSpec([]), 'result' => null]);
        [, $err] = LmWhatsappMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmWhatsappSpec(['step' => 's']),
            'result' => new LmWhatsappResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LmWhatsappOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmWhatsappMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmWhatsappSpec(['step' => 's']),
            'result' => new LmWhatsappResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LmWhatsappOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmWhatsappMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmWhatsappResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LmWhatsappSpec([]),
            'result' => new LmWhatsappResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LmWhatsappMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmWhatsappMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LmWhatsappError('boom', 'boom');
        $utility->fetcher = function (LmWhatsappContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmWhatsappSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LmWhatsappMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LmWhatsappContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LmWhatsappMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LmWhatsappResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        LmWhatsappMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LmWhatsappContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmWhatsappSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LmWhatsappMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LmWhatsappResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LmWhatsappSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LmWhatsappMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LmWhatsappMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LmWhatsappMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LmWhatsappResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LmWhatsappDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LmWhatsappResult(['ok' => false])]);
        $this->expectException(LmWhatsappError::class);
        LmWhatsappDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LmWhatsappResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LmWhatsappMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LmWhatsappMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LmWhatsappBaseFeature();
        $b = new LmWhatsappBaseFeature();
        LmWhatsappFeatureAdd::call($ctx, $a);
        LmWhatsappFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LmWhatsappBaseFeature
    {
        $f = new LmWhatsappBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LmWhatsappFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LmWhatsappContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LmWhatsappSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmWhatsappPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        LmWhatsappPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LmWhatsappResponse(['headers' => null]),
            'result' => new LmWhatsappResult([]),
        ]);
        LmWhatsappResultHeaders::call($ctx);
