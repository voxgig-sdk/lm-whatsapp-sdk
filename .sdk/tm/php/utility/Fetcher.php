...
// LmWhatsapp SDK utility: fetcher

class LmWhatsappFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LmWhatsappSDK/1.0)';
    ...
    public static function call(LmWhatsappContext $ctx, string $fullurl, array $fetchdef): array
    {
