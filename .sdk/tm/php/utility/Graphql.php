...
// LmWhatsapp SDK utility: graphql
//
...
class LmWhatsappGraphql
{
    ...
    // equivalent.
    public static function body(LmWhatsappContext $ctx): mixed
    {
    ...
    public static function errors(LmWhatsappContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
