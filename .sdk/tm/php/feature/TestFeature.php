...
// LmWhatsapp SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LmWhatsappTestFeature extends LmWhatsappBaseFeature
{
    ...
    public function init(LmWhatsappContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LmWhatsappContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = LmWhatsappParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LmWhatsappContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LmWhatsappContext $ctx, $op, $args): array
    {
