...
class LmWhatsappCacheFeature extends LmWhatsappBaseFeature
{
    ...
    private function _through(LmWhatsappContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
