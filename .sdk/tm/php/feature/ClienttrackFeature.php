...
// LmWhatsapp SDK clienttrack feature
...
class LmWhatsappClienttrackFeature extends LmWhatsappBaseFeature
{
    ...
    public function PostConstruct(LmWhatsappContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LmWhatsapp-SDK';
