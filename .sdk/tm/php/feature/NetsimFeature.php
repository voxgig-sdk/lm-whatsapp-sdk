...
class LmWhatsappNetsimFeature extends LmWhatsappBaseFeature
{
    ...
    private function _simulate(LmWhatsappContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LmWhatsappContext $ctx, array $applied): void
    {
        $client = $this->client;
