...
class LmWhatsappRbacFeature extends LmWhatsappBaseFeature
{
    ...
    private function _required(LmWhatsappContext $ctx): ?string
    {
    ...
    private function _reject(LmWhatsappContext $ctx, string $required): void
    {
    ...
    private function _track(LmWhatsappContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
