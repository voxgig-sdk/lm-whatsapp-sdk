...
// LmWhatsapp SDK timeout feature
...
class LmWhatsappTimeoutFeature extends LmWhatsappBaseFeature
{
    ...
    private function _with_timeout(LmWhatsappContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LmWhatsappContext $_ctx, float $ms): void
    {
        $client = $this->client;
