...
class LmWhatsappPagingFeature extends LmWhatsappBaseFeature
{
    ...
    private function _graphql_pre_request(LmWhatsappContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(LmWhatsappContext $ctx): bool
    {
