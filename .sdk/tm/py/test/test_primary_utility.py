...
from projectname_sdk import LmWhatsappSDK
from projectname_sdk.core.spec import LmWhatsappSpec
from projectname_sdk.core.result import LmWhatsappResult
from projectname_sdk.core.response import LmWhatsappResponse
from projectname_sdk.core.operation import LmWhatsappOperation
from projectname_sdk.core.error import LmWhatsappError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import LmWhatsappBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return LmWhatsappError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = LmWhatsappSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = LmWhatsappSDK.test(None, None)
        ...
        class TestInitFeature(LmWhatsappBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LmWhatsappBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LmWhatsappSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LmWhatsappSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LmWhatsappSDK.test(None, setup_opts)
