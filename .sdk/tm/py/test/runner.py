...
class LmWhatsappTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmWhatsappTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LmWhatsappTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LmWhatsappTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
