...
class LmWhatsappTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmWhatsappTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LmWhatsappTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LmWhatsappTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
