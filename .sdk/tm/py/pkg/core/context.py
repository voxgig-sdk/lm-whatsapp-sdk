...
class LmWhatsappContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, LmWhatsappSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LmWhatsappResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LmWhatsappResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LmWhatsappError(code, msg, self)
