...
class WhatsAppTemplateGetV2EntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LMWHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V__ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def whats_app_template_get_v2_basic_setup(extra)
  ...
  entid_env_raw = ENV["LMWHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V__ENTID"]
