...
class WhatsAppTemplateGetV2Entity
  def initialize(client, entopts = nil)
    ...
    @_name = "whats_app_template_get_v2"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    WhatsAppTemplateGetV2Entity.new(@_client, opts)
  end
  ...
  # @return [WhatsAppTemplateGetV2, Hash] the current WhatsAppTemplateGetV2 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WhatsAppTemplateGetV2 fields)
  def match_get
  ...
  #
  # @param reqmatch [WhatsAppTemplateGetV2LoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.WhatsAppTemplateGetV2.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [WhatsAppTemplateGetV2, Hash] the loaded WhatsAppTemplateGetV2; raises LmWhatsappError on failure
