...
class TemplateEntity
  ...
  # @return [Template, Hash] the created Template; raises LmWhatsappError on failure
  ...
  #
  # @param reqdata [TemplateUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Template, Hash] the updated Template; raises LmWhatsappError on failure
