# LmWhatsapp SDK SendMessage entity
...
class SendMessageEntity
  ...
  def make
    opts = @_entopts.dup
    SendMessageEntity.new(@_client, opts)
  end
  ...
  # @return [SendMessage, Hash] the current SendMessage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SendMessage fields)
  def match_get
  ...
  #
  # @param reqdata [SendMessageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SendMessage, Hash] the created SendMessage; raises LmWhatsappError on failure
