...
class ManageTemplateEntity
  ...
  def make
    opts = @_entopts.dup
    ManageTemplateEntity.new(@_client, opts)
  end
  ...
  # @return [ManageTemplate, Hash] the current ManageTemplate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ManageTemplate fields)
  def match_get
  ...
  #
  # @param reqmatch [ManageTemplateRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ManageTemplate, Hash] the removed ManageTemplate; raises LmWhatsappError on failure
