...
class LmWhatsappSDK {
  ...
  ManageTemplate(data?: any) {
    const self = this
    return new ManageTemplateEntity(self,data)
  }
  ...
  SendMessage(data?: any) {
    const self = this
    return new SendMessageEntity(self,data)
  }
  ...
  WhatsAppTemplateGetV2(data?: any) {
    const self = this
    return new WhatsAppTemplateGetV2Entity(self,data)
  }


  // Entity access: `client.WhatsAppTemplateGetV2Pagination().list()` / `client.WhatsAppTemplateGetV2Pagination().load({ id })`.
  WhatsAppTemplateGetV2Pagination(data?: any) {
    const self = this
    return new WhatsAppTemplateGetV2PaginationEntity(self,data)
  }
