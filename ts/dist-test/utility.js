...
function envOverride(m) {
    if ('TRUE' === process.env.LM_WHATSAPP_TEST_LIVE ||
        'TRUE' === process.env.LM_WHATSAPP_TEST_OVERRIDE) {
    ...
    m.LM_WHATSAPP_TEST_EXPLAIN = process.env.LM_WHATSAPP_TEST_EXPLAIN || m.LM_WHATSAPP_TEST_EXPLAIN;
    return m;
}
