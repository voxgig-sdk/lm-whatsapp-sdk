...
function envOverride(m) {
    if ('TRUE' === process.env.LMWHATSAPP_TEST_LIVE ||
        'TRUE' === process.env.LMWHATSAPP_TEST_OVERRIDE) {
    ...
    m.LMWHATSAPP_TEST_EXPLAIN = process.env.LMWHATSAPP_TEST_EXPLAIN || m.LMWHATSAPP_TEST_EXPLAIN;
    return m;
}
