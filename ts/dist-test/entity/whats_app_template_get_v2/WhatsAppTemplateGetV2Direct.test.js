...
(0, node_test_1.describe)('WhatsAppTemplateGetV2Direct', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LmWhatsappSDK({
    ...
    (0, node_test_1.test)('direct-load-whats_app_template_get_v2', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-whats_app_template_get_v2', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LmWhatsappSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.LM_WHATSAPP_APIKEY,
        }));
        let idmap = env['LM_WHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V2_ENTID'];
    ...
    const client = new __1.LmWhatsappSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=WhatsAppTemplateGetV2Direct.test.js.map