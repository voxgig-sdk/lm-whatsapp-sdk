...
func registerSDKWords(r *eng.Registry, client *sdk.LmWhatsappSDK) {
...
func runOp(client *sdk.LmWhatsappSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
