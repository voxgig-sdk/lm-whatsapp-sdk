...
type ManageTemplateEntity struct {
	name    string
...
func NewManageTemplateEntity(client *core.LmWhatsappSDK, entopts map[string]any) *ManageTemplateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ManageTemplateEntity) GetName() string { return e.name }
...
func (e *ManageTemplateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ManageTemplateEntity) Deleted() bool {
	return e.deleted
}


func (e *ManageTemplateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewManageTemplateEntity(e.client, opts)
}

func (e *ManageTemplateEntity) Data(args ...any) any {
...
func (e *ManageTemplateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ManageTemplate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ManageTemplateEntity) DataTyped(data ...ManageTemplate) ManageTemplate {
	if len(data) > 0 {
		return typedFrom[ManageTemplate](e.Data(asMap(data[0])))
	}
	return typedFrom[ManageTemplate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ManageTemplate (all fields
// optional at the wire level).
func (e *ManageTemplateEntity) MatchTyped(match ...ManageTemplate) ManageTemplate {
	if len(match) > 0 {
		return typedFrom[ManageTemplate](e.Match(asMap(match[0])))
	}
	return typedFrom[ManageTemplate](e.Match())
}
...
func (e *ManageTemplateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ManageTemplateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ManageTemplateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ManageTemplateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ManageTemplateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ManageTemplateEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ManageTemplateRemoveMatch and returns an ManageTemplate. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ManageTemplateEntity) RemoveTyped(reqmatch ManageTemplateRemoveMatch, ctrl map[string]any) (ManageTemplate, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ManageTemplate{}, err
	}
	return typedFrom[ManageTemplate](res), nil
}



func (e *ManageTemplateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
