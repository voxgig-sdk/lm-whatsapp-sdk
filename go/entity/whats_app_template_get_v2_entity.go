...
type WhatsAppTemplateGetV2Entity struct {
	name    string
...
func NewWhatsAppTemplateGetV2Entity(client *core.LmWhatsappSDK, entopts map[string]any) *WhatsAppTemplateGetV2Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhatsAppTemplateGetV2Entity) Deleted() bool {
	return e.deleted
}


func (e *WhatsAppTemplateGetV2Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhatsAppTemplateGetV2Entity(e.client, opts)
}

func (e *WhatsAppTemplateGetV2Entity) Data(args ...any) any {
...
func (e *WhatsAppTemplateGetV2Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WhatsAppTemplateGetV2; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhatsAppTemplateGetV2Entity) DataTyped(data ...WhatsAppTemplateGetV2) WhatsAppTemplateGetV2 {
	if len(data) > 0 {
		return typedFrom[WhatsAppTemplateGetV2](e.Data(asMap(data[0])))
	}
	return typedFrom[WhatsAppTemplateGetV2](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WhatsAppTemplateGetV2 (all fields
// optional at the wire level).
func (e *WhatsAppTemplateGetV2Entity) MatchTyped(match ...WhatsAppTemplateGetV2) WhatsAppTemplateGetV2 {
	if len(match) > 0 {
		return typedFrom[WhatsAppTemplateGetV2](e.Match(asMap(match[0])))
	}
	return typedFrom[WhatsAppTemplateGetV2](e.Match())
}
...
func (e *WhatsAppTemplateGetV2Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhatsAppTemplateGetV2Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhatsAppTemplateGetV2LoadMatch and returns an WhatsAppTemplateGetV2. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WhatsAppTemplateGetV2Entity) LoadTyped(reqmatch WhatsAppTemplateGetV2LoadMatch, ctrl map[string]any) (WhatsAppTemplateGetV2, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WhatsAppTemplateGetV2{}, err
	}
	return typedFrom[WhatsAppTemplateGetV2](res), nil
}



func (e *WhatsAppTemplateGetV2Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WhatsAppTemplateGetV2Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhatsAppTemplateGetV2Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhatsAppTemplateGetV2Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
