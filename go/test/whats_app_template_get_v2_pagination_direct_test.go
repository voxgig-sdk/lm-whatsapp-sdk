...
func whats_app_template_get_v2_paginationDirectSetup(mockres any) *whats_app_template_get_v2_paginationDirectSetupResult {
	...
	env := envOverride(map[string]any{
		"LMWHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V__PAGINATION_ENTID": map[string]any{},
	...
	if live {
		...
		idmap := map[string]any{}
		if entidRaw, ok := env["LMWHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V__PAGINATION_ENTID"]; ok {
