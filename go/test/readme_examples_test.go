...
const testSeed = `map[string]any{"entity": map[string]any{"manage_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "media": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whats_app_template_get_v2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whats_app_template_get_v2_pagination": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
