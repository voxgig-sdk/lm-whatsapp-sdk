...
describe("WhatsAppTemplateGetV2Entity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LMWHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V__ENTID JSON to run live")
      return
    end
...
function whats_app_template_get_v2_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LMWHATSAPP_TEST_WHATS_APP_TEMPLATE_GET_V__ENTID")
