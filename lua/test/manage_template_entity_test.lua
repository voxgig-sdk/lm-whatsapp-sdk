...
describe("ManageTemplateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LMWHATSAPP_TEST_MANAGE_TEMPLATE_ENTID JSON to run live")
      return
    end
...
function manage_template_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LMWHATSAPP_TEST_MANAGE_TEMPLATE_ENTID")
