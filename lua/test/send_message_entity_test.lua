...
describe("SendMessageEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LM_WHATSAPP_TEST_SEND_MESSAGE_ENTID JSON to run live")
      return
    end
...
function send_message_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LM_WHATSAPP_TEST_SEND_MESSAGE_ENTID")
