...
local ManageTemplateEntity = {}
ManageTemplateEntity.__index = ManageTemplateEntity


function ManageTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ManageTemplateEntity)
  self._name = "manage_template"
  self._client = client
...
function ManageTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ManageTemplateEntity.new(self._client, opts)
end
...
function ManageTemplateEntity:mark_deleted()
  self._deleted = true
end


function ManageTemplateEntity:deleted()
  return true == self._deleted
end


function ManageTemplateEntity:data_set(args)
  if args ~= nil then
...
function ManageTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ManageTemplateEntity:match_set(args)
  if args ~= nil then
...
function ManageTemplateEntity:match_get()
...
function ManageTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch ManageTemplateRemoveMatch
---@param ctrl? table
---@return ManageTemplate
---@return string? err
function ManageTemplateEntity:remove(reqmatch, ctrl)
  local utility = self._utility
