-- LmWhatsapp SDK WhatsAppTemplateGetV2Pagination entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local WhatsAppTemplateGetV2PaginationEntity = {}
WhatsAppTemplateGetV2PaginationEntity.__index = WhatsAppTemplateGetV2PaginationEntity


function WhatsAppTemplateGetV2PaginationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WhatsAppTemplateGetV2PaginationEntity)
  self._name = "whats_app_template_get_v2_pagination"
  self._client = client
...
function WhatsAppTemplateGetV2PaginationEntity:get_name()
  return self._name
end


function WhatsAppTemplateGetV2PaginationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WhatsAppTemplateGetV2PaginationEntity.new(self._client, opts)
end
...
function WhatsAppTemplateGetV2PaginationEntity:mark_deleted()
  self._deleted = true
end


function WhatsAppTemplateGetV2PaginationEntity:deleted()
  return true == self._deleted
end


function WhatsAppTemplateGetV2PaginationEntity:data_set(args)
  if args ~= nil then
...
function WhatsAppTemplateGetV2PaginationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WhatsAppTemplateGetV2PaginationEntity:match_set(args)
  if args ~= nil then
...
function WhatsAppTemplateGetV2PaginationEntity:match_get()
...
function WhatsAppTemplateGetV2PaginationEntity:stream(action, args, callopts)
...
---@param reqmatch WhatsAppTemplateGetV2PaginationLoadMatch
---@param ctrl? table
---@return WhatsAppTemplateGetV2Pagination
---@return string? err
function WhatsAppTemplateGetV2PaginationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function WhatsAppTemplateGetV2PaginationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WhatsAppTemplateGetV2PaginationEntity
