...
local WhatsAppTemplateGetV2Entity = {}
WhatsAppTemplateGetV2Entity.__index = WhatsAppTemplateGetV2Entity


function WhatsAppTemplateGetV2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WhatsAppTemplateGetV2Entity)
  self._name = "whats_app_template_get_v2"
  self._client = client
...
function WhatsAppTemplateGetV2Entity:get_name()
  return self._name
end


function WhatsAppTemplateGetV2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WhatsAppTemplateGetV2Entity.new(self._client, opts)
end
...
function WhatsAppTemplateGetV2Entity:mark_deleted()
  self._deleted = true
end


function WhatsAppTemplateGetV2Entity:deleted()
  return true == self._deleted
end


function WhatsAppTemplateGetV2Entity:data_set(args)
  if args ~= nil then
...
function WhatsAppTemplateGetV2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WhatsAppTemplateGetV2Entity:match_set(args)
  if args ~= nil then
...
function WhatsAppTemplateGetV2Entity:match_get()
...
function WhatsAppTemplateGetV2Entity:stream(action, args, callopts)
...
---@param reqmatch WhatsAppTemplateGetV2LoadMatch
---@param ctrl? table
---@return WhatsAppTemplateGetV2
---@return string? err
function WhatsAppTemplateGetV2Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function WhatsAppTemplateGetV2Entity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WhatsAppTemplateGetV2Entity
